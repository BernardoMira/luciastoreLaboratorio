...
import storeapp.infraestructure.out.mapper.OrderRowMapper;
...
public class OrderRepositoryDB implements OrderPersistencePort {


    private final Connection connection;
    private final OrderRowMapper orderRowMapper;

    public OrderRepositoryDB(Connection connection, OrderRowMapper orderRowMapper) {
