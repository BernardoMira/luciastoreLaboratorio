...
public class AdminView {
    ...
    private final CustumerAdminService custumerAdminService;
    private final Admin admin;


    public AdminView(AdminService adminService , Admin admin , CustumerAdminService custumerAdminService) {
